    ...
    const content = [
        {
            ...
            desc: "Diversify wisely with Separate Bottles Investments—uncork unique opportunities, one vintage at a time, in this exclusive investment experience. Savor distinct returns, each bottle a chapter in your financial journey."
        }
    ]
